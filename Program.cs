...
namespace DIOSeries
{
    class Program
    {
		...
		private static void ExcluirSerie()
		{
			...
			Console.WriteLine("Você deseja mesmo apagar essa série?");
		...
		private static void ResgatarSerie()
		{
			Console.Write("Digite o id da série: ");
			int indiceSerie = int.Parse(Console.ReadLine());

			repositorio.RecuperaItem(indiceSerie);
			Console.WriteLine("Série recuperada com sucesso!");
		}
		...
		private static string ObterOpcaoUsuario()
		{
			...
			Console.WriteLine("6- Recuperar série excluída");
